...
for x in n_hidden:                          #looking or the best parameters w.r.t the number of hidden layers
    for y in n_neurons:                      #looking or the best parameters w.r.t the number of neurons
        for z in l_rate:                  #looking or the best parameters w.r.t the learning rate

            #build the model for each combination by calling the function:
            model = build_model(n_hidden=x,n_neurons_hidden=y,n_neurons_output=len(class_names),learning_rate=z)
            #-->add your Pyhton code here
            ...
            if (accuracy > highestAccuracy):
                ...
                print("Parameters: " + "Number of Hidden Layers: " + str(x) + ",number of neurons: " + str(y) + ",learning rate: " + str(z))
                print()
